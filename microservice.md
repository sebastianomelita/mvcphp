...
- client http SW, incorporati sul server, che eseguoono il prelievo (fetch) dal microservizio dei dati da inserire all'interno del codice HTML di una pagina web tradizionale per opera di un motore di scripting (PHP, Java, Python, Node.JS, ...).
