...
- una **struttura dati provvisoria** che contiene dati non degni di essere persistenti perchè soggetti a manipolazioni o ad **aggiornamenti iterattivi**  da parte dell'utente (carrello della spesa di un e-commerce)
