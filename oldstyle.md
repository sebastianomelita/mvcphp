...
1.	Sul **client**, in questo caso viene memorizzata **insieme al cookie** che identifica il browser dell’utente. Ad esempio, in jajacript ciò si può fare con la funzione **window.localStorage**.
