...
In sostanza, una applicazione MVC è una **architettura di classi** di **contoller**, **vista** e **modello** i cui **metodi** vengono, di volta in volta, **richiamati** da un certo metodo del **controlle**r per eseguire proprio **quella azione** che è indicata all'interno del **path** dell'indirizzo URL della richiesta HTTP:
