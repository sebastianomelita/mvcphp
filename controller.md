...
- il **path_locale** indica il percorso dell'applicazione server all'interno del filesytem della macchina (generalmente all0interno della cartella wwww di pubblicazione)
