...
Esempio di funzione del controller che **inserisce** nel database una Pizza (record principale) e tutti i suoi ingredienti (lista di record secondari) prelevando i valori dai parametri POST inviati dal form richiamato col codice precedente:
```PHP
